...
| `filter.contributions.by`       | Filters by agent identifier who contributed to the research product. |
| `filter.contributions.declared_affiliation`       | Filters by the declared affiliation of the agent that contributed to the research product. |
