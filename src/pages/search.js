...
import { FaSearch, FaEye, FaDownload, FaExternalLinkAlt, FaBorderNone } from 'react-icons/fa';
...
const SearchPage = () => {
    ...
    const sanitizeInput = (input) => {
        return input.replace(/!/g, ''); // Remove any "!" from the input
    };
    ...
    const fetchDepositions = async (term, pageNum) => {
        ...
        setError(null);
        try {
            const sanitizedTerm = sanitizeInput(term); // Sanitize before sending
